    ...
    <div class="text-secondary px-1 py-5 text-center">
        <div class="col d-flex flex-column gap-4">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-center" style="font-family: 'labster', cursive;">
                <button type="button" class="btn btn-dark btn-lg px-4 me-md-2">Shop All</button>
                <button type="button" class="btn btn-outline-dark btn-lg px-4">Our Story</button>
            </div>
        </div>
...
<div class="container-fluid py-3 text-center ">
    ...
    <div class="row flex-lg justify-content-center align-items-center p-3 p-sm-5">
        <div class="col col-sm-6 col-lg-6 ">
            <img src="./src/images/amavida.jpg" class="d-block mx-lg-auto img-fluid rounded-3" alt="Bootstrap Themes" width="500" height="400" loading="lazy">
        </div>
    ...
    <div class="row flex-lg justify-content-center align-items-center p-3 p-sm-5">
        ...
        <div class="col col-sm-6 col-lg-6 ">
            <img src="./src/images/tacori.jpg" class="d-block mx-lg-auto img-fluid rounded-3" alt="Bootstrap Themes" width="500" height="400" loading="lazy">
        </div>
    ...
    <div class="row flex-lg justify-content-center align-items-center p-3 p-sm-5">
        <div class="col col-sm-6 col-lg-6 ">
            <img src="./src/images/henri_daussi.jpg" class="d-block mx-lg-auto img-fluid rounded-3" alt="Bootstrap Themes" width="500" height="400" loading="lazy">
        </div>
        <div class="col-sm-6 px-5 text-md-start d-flex flex-column gap-3">
...
<div class="container-fluid p-3 p-sm-5 mb-4">
    ...
    <div class="row  justify-content-center row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
        ...
        <div class="col">
            <div class="card border border-warning shadow-0 mb-3">
                <div class="card d-flex align-items-center  gap-3 flex-row  text-dark border-0 p-2">
                    <img src="./src/images/img%20(9).png" class="rounded-circle" style="width: 50px; height: 50px" alt="Avatar" />
        ...
        <div class="col">
            <div class="card border border-warning shadow-0 mb-3">
                <div class="card d-flex align-items-center  gap-3 flex-row  text-dark border-0 p-2">
                    <img src="./src/images/img%20(1).png" class="rounded-circle" style="width: 50px; height: 50px" alt="Avatar" />
                    <div class="row" style="font-family: 'Poppins', cursive; ">
        ...
        <div class="col">
            <div class="card border border-warning shadow-0 mb-3">
                <div class="card d-flex align-items-center  gap-3 flex-row  text-dark border-0 p-2">
                    <img src="./src/images/img%20(2).png" class="rounded-circle" style="width: 50px; height: 50px" alt="Avatar" />
                    <div class="row" style="font-family: 'Poppins', cursive; ">
