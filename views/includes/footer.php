...
<body>
    ...
    <footer class="bd-footer" style="background-color: #FFEFD5;">
            ...
            <div class="row ">
                ...
                <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Home</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Docs</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Examples</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Themes</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-3">
                    <h5>Services</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Getting started</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Starter template</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Webpack</a></li>
                        <li class="mb-2"><a class="text-decoration-none text-secondary" href="#">Parcel</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-3">
                    <h5>Social Media</h5>
